...
quiz_option_model = quest_ns.model("Option", {
...
quiz_level_model = quest_ns.model('Level', {
    ...
    "options": fields.List(fields.Nested(quiz_option_model), required=False, description="List of options for the quiz question"),
...
create_quest_model = quest_ns.model('CreateQuest', {
    ...
    "levels": fields.List(fields.Nested(quiz_level_model), description="A list of levels in the quest (can be input or quiz levels)"),
})
